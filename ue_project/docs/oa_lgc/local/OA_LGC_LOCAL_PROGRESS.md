...
| L3 Virtual Update | partial pass | `ecdeda1` | `6a9f47d` | `artifacts/oa_lgc/local/20260713_221051_396241_L3_seed0/` | proxy J=1/3/5、双轨、base immutable、delta gradient 通过；真实 YOLO adapter 未验证 |
...
| L6 End-to-End Smoke | partial pass | `161e529` | `1a54572` + final correction | `artifacts/oa_lgc/local/20260713_223253_761596_L6_seed0/` | proxy J=1/3/5、backward、authorized class、复现通过；真实 YOLO subchain 未验证 |
| L7 Cleanup and Finalization | pass | `1a54572` | `fdb921e` | `docs/oa_lgc/local/L7_CLEANUP_REPORT.md` | files removed=0；artifact audit complete；91 passed |
